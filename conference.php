...
OR <a href='#' onclick='window.open("pdfs/2018conferenceregistration.pdf");'>download</a> the registration form, complete it and mail to us</a>
</td></tr>
</table>
<br/>
...
<li><a href='#' onclick='window.open("pdfs/5th_conference_food.pdf");'>food</a></li>
<li><a href='#' onclick='window.open("pdfs/5th_conference_resouce_panel.pdf");'>resource panel</a></li>
<li><a href='#' onclick='window.open("pdfs/5th_conference_healing.pdf");'>healing</a></li>
<li><a href='#' onclick='window.open("pdfs/5th_conference_keynotes.pdf");'>key notes</a></li>
<li><a href='#' onclick='window.open("pdfs/5th_conference_pain_management.pdf");'>pain management</a></li>
<li><a href='#' onclick='window.open("pdfs/5th_conference_radiation_therapy.pdf");'>radiation therapy</a></li>
</ul-->
